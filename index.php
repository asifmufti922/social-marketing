...
<body>
    ...
    <div class="container">
        ...
        <div class="top-buttons">
            <a href="#" class="btn-refill">Refill Order</a>
            <a href="#" class="btn-add-fund">Add Fund</a>
        </div>

        <div class="header">
            <img src="https://i.postimg.cc/P50MnT8b/IMG-20250301-WA0011.jpg" alt="Logo">
            <h1>Abdullah ❤️ Hafiz</h1>
        </div>
        ...
        <div id="inputs-section" style="display: none;">
            <form method="POST" action="">
                ...
                <div class="input-group">
                    ...
                    <input type="number" id="quantity" name="quantity" min="100" max="10000" value="1000" oninput="validateQuantity()">
    ...
    <!-- WhatsApp Button -->
    <div class="whatsapp-button" onclick="window.open('https://wa.me/+923225815922?text=Assalamualaikum%20Hafiz%20Muhammad%20Ali', '_blank')">
    ...
    <script>
        const services = {
            TikTok: {
                ...
                "TikTok Followers Pakistani🇵🇰 Lifetime Non Drop": { price: 500, logo: "https://www.freepnglogos.com/uploads/tik-tok-logo-png/tik-tok-logo-vectors-9.png" },
            ...
            Hussain: {
                ...
                "Boss Views Aapke liye": { price: 1, logo: "https://i.postimg.cc/tg0YNFkh/IMG-20250301-WA0027.jpg" }
            }
        };
        ...
        function selectCategory(category) {
            ...
            document.getElementById("category").value = category; // Set hidden input value
            document.getElementById("category-list").style.display = "none";

            // Clear password input and show password section for Hussain category
            if (category === "Hussain") {
                document.getElementById("boss-password").value = ""; // Clear password input
        ...
        function checkPassword() {
            ...
            if (password === "Abdullahafiz") {
                ...
                // Hide password section and show service dropdown
                document.getElementById("password-section").style.display = "none";
                document.getElementById("service-dropdown").style.display = "block";
                let serviceList = document.getElementById("service-list");
                serviceList.innerHTML = "";
                ...
                // Speech synthesis for wrong password
                const speech = new SpeechSynthesisUtterance();
        ...
        function selectService(service, pricePer1000) {
            ...
            document.getElementById("service").value = service; // Set hidden input value
            ...
            // Speak the selected service name
            if (selectedCategory === "Hussain") {
                const speech = new SpeechSynthesisUtterance();
                speech.text = `You selected ${service}`;
                window.speechSynthesis.speak(speech);
            }
        }
        ...
        function calculatePrice() {
            ...
            document.getElementById("price-value").value = totalPrice; // Set hidden input value
        }
        ...
        function confirmOrder() {
            ...
            setTimeout(() => {
                ...
                // Reset password section for Hussain category
                if (selectedCategory === "Hussain") {
                    document.getElementById("boss-password").value = ""; // Clear password input
                    document.getElementById("password-section").style.display = "block";
                    document.getElementById("service-dropdown").style.display = "none";
        ...
        function isValidWhatsAppNumber(number) {
            const regex = /^03\d{9}$/; // Pakistani number format
        ...
        // Real-time validation for video link
